      ...
      {isVisible && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-0 md:inset-auto flex items-center justify-center md:items-start md:justify-end md:top-auto md:bottom-6 md:right-6 z-50 px-4 py-4 md:p-0"
          >
            <div className="max-w-md w-full md:w-auto mx-auto md:mx-0">
              <div className="glass-card p-6 shadow-2xl">
              <div className="flex items-start gap-4">
                <div className="flex-1">
                  <h3 className="heading-3 mb-2 text-white">Stay Connected!</h3>
                  <p className="body-subtle mb-4 text-white">
                    Join our community to get the latest updates on events, hackathons, and scholarships.
                  </p>
                  <div className="flex gap-3">
                    ...
                    >
                      <svg
                        className="w-5 h-5 force-white-fill"
                        viewBox="0 0 24 24"
                        fill="white"
                      >
