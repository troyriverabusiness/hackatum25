...
const Hero = ({ onJoinClick }) => {
  return (
    <section className="relative flex min-h-[calc(100vh-5rem)] items-center">
      <div className="section-container section-padding relative flex flex-col items-center justify-center text-center">
        <motion.div
        ...
        >
          ...
          >
            Connecting the next generation of tech talent to opportunities
          </motion.h1>
          <motion.p
            className="body-hero"
            initial={{ opacity: 0, y: 16 }}
          ...
          >
            We make it easier to discover the people, projects, and opportunities driving our local tech community forward.
          </motion.p>
          <motion.div
            className="btn-group"
            initial={{ opacity: 0, y: 16 }}
          ...
          <motion.div
            className="flex md:hidden items-center justify-center gap-6 pt-4"
            initial={{ opacity: 0, y: 16 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <svg width="0" height="0" style={{ position: 'absolute' }}>
              <defs>
                <linearGradient id="linkedin-gradient-mobile" x1="0%" y1="0%" x2="100%" y2="0%">
            ...
            >
              <svg
                className="w-10 h-10"
                fill="url(#linkedin-gradient-mobile)"
                viewBox="0 0 24 24"
                aria-label="LinkedIn"
              >
      ...
      {/* Scroll down thingy: */}
      {/* <motion.div
        className="absolute bottom-10 left-1/2 hidden -translate-x-1/2 items-center gap-2 text-xs uppercase tracking-[0.5em] text-white/60 sm:flex"
